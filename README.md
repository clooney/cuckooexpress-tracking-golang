# Cuckoo Express Tracking API For Golang
Cuckoo Express Tracking API and webhook make it easy to integrate Cuckoo Express Tracking function into your own project. Support APIs Client Libraries for golang

### API key

In order to use this API, you need to generate a Cuckoo Express Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code. use Cuckoo Express Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [Cuckoo Express Tracking API](https://www.trackingmore.com/cuckooexpress-tracking.html)  to:

   *   Get Cuckoo Express realtime tracking info of muti-carriers in one integration
   *   Provide Cuckoo Express shipment tracking experience like Amazon
   *   Push Cuckoo Express notifications of package update with webhook
   *   Verify Cuckoo Express delivery exception before it is too late
